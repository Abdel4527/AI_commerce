    ...
    return (
        <div className='flex'>
            <div className='w-full md:w-1/2 flex flex-col justify-center items-center p-8 md:p-12'>
                <form onSubmit={handleSubmit} className='w-full max-w-md bg-white p-8 rounded-lg border shadpw-sm'>
            ...
            <div className='hidden md:block w-1/2 bg-gray-800'>
                <div className='h-full flex flexcol justify-center items-center'>
                    <img 
                        src={login}
